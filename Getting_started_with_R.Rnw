...
\title{20 Things You Need To Know About \r}
...
\date[September 2020]{\small September 2020}%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{20 Things You Need To Know About \r}
...
\textbf{NB:}
\begin{itemize}
\item an RStudio project is a folder containing the different files for a given project, including a simple project file that allows for us to open RStudio with the correct working directory set
...
\item To decipher the second example, run things adding one line at a time
\end{itemize}
\vfill
Here the implementation from the previous slide was easier to read but this is not always the most natural way to write
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{19. How to reach level A2/B1?}
